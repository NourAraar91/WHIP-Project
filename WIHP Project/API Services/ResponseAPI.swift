...
final class ResponseAPI: GenericService {
    ...
    func request(completionHandler handler: @escaping (_ response: ResponseAPIResponse) -> Void, failureHandler failHandler: @escaping(_ error: ErrorResponse) -> Void = { _ in }) {
        let url = "https://skyrim.whipmobility.io/v10/analytic/dashboard/operation/mock?scope=LAST_7_DAYS"
